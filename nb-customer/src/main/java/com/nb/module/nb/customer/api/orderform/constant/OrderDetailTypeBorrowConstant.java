...
public enum OrderDetailTypeBorrowConstant {
	...
	ORDER_DETAIL_TYPE_BORROW(1, "发起借阅申请", OrderFormConstant.SEND_TO_OWNER),
...
//	ORDER_DETAIL_TYPE_BORROW_OWNER_DELIVERY(3, "上家发货", OrderFormConstant.SEND_TO_BORROWER),
	...
	ORDER_DETAIL_TYPE_BORROW_CONFIRM(4, "借阅", OrderFormConstant.SEND_TO_BORROWER),

	//	ORDER_DETAIL_TYPE_BORROW_BORROWER_RENEW(5, "下家续借", OrderFormConstant.SEND_TO_OWNER),
	ORDER_DETAIL_TYPE_RENEW(5, "发起续借申请", OrderFormConstant.SEND_TO_OWNER),

	//	ORDER_DETAIL_TYPE_BORROW_OWNER_CONFIRM_RENEW(6, "上家确认续借", OrderFormConstant.SEND_TO_BORROWER),
	ORDER_DETAIL_TYPE_RENEW_CONFIRM(6, "续借", OrderFormConstant.SEND_TO_BORROWER),
...
//	ORDER_DETAIL_TYPE_BORROW_BORROWER_RETURN(7, "下家还书", OrderFormConstant.SEND_TO_OWNER),
	...
	ORDER_DETAIL_TYPE_RETURN(8, "归还图书", OrderFormConstant.SEND_TO_OWNER),

	ORDER_DETAIL_TYPE_CANCEL(9, "取消借阅", OrderFormConstant.SEND_TO_OWNER);
